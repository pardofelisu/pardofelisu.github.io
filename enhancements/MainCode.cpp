...
// DATE         COMMENTS		
// ----         --------------------------------------------------------
// Nov 23, 2025  Included AllInOne.py for final project enhancements
// Nov 30, 2025  Added database handling functions
///////////////////////////////////////////////////////////////////////////////
...
#include "AllInOne.py"
#include "databaseHandle.js"

// Namespace for declaring global variables
namespace
{
	// Macro for window title
	const char* const WINDOW_TITLE = "CS499 Final project enhancements"; 
...

{
	...
	// call AllInOne.py functions
	AllInOne::runAll();

	// initialize the in-memory database
	initializeDatabase();
	// add some initial items
	addItem("baseballbat", "Bedroom");
	addItem("compass", "Bedroom");
	addItem("monster", "Main Hall");
	addItem("key", "Closet");
