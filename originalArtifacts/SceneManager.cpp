...
////////////////////////////////////////////////////////////////////////////////
//UPDATE LOG:
// created textures for new rooms, as well as a few objects and materials
//
// RESPONSIBILITIES:
...
void SceneManager::RenderScene()
{
	...
	//builds a floor adjacent to the wall
	scaleXYZ = glm::vec3(10.0f, 1.0f, 10.0f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	...
	// builds the wall adjacent to the floor
	scaleXYZ = glm::vec3(10.0f, 1.0f, 10.0f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
...
// set the XYZ scale for the mesh
	...
	//builds a door next to the window
	scaleXYZ = glm::vec3(2.0f, 5.0f, 1.0f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-9.0f, 2.0f, -5.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
	...
	//builds a small sphere on the bedside table, is the compass

	scaleXYZ = glm::vec3(0.5f, 0.5f, 0.5f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-8.0f, 3.0f, -5.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
		ZrotationDegrees,
		positionXYZ);
	SetShaderTexture("compass");
	SetShaderMaterial("metal");//implement metal material later, and find texture

	m_basicMeshes->DrawSphereMesh();

	//builds a pole as a baseball bat leaning against the wall
	...
	SetTransformations(
		...
		ZrotationDegrees,
		positionXYZ);
	SetShaderTexture("bat");
	SetShaderMaterial("wood");

	m_basicMeshes->DrawBoxMesh();

	//builds cylindrical figure as a stand in for the final monster design
	...
	SetTransformations(
		...
		ZrotationDegrees,
		positionXYZ);
	SetShaderTexture("monster");//implement monster texture later
